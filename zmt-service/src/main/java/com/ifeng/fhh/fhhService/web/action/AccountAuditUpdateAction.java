...
import com.ifeng.fhh.fhhService.model.transform.account.AccountAuditUpdateReq;
...
public class AccountAuditUpdateAction implements RouteAction {

    private static final Logger LOG = LoggerFactory.getLogger(AccountAuditUpdateAction.class);
    ...
    @Override
    @RequestMapping(path = "/auditor/account/update/", method = RequestMethod.POST)
    public CompletableFuture<ActionResponse> route(ActionRequest request) {
        ...
        try {
            ...
            AccountAuditUpdateReq accountSaveReq = JSON.parseObject(bodyJson, AccountAuditUpdateReq.class);
            ...
            LOG.error("execute account auditor update fail: {}", e);
