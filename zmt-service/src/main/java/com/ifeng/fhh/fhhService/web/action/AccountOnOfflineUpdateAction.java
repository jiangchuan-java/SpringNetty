...
import com.ifeng.fhh.fhhService.model.transform.account.AccountOnOfflineUpdateReq;
...
public class AccountOnOfflineUpdateAction implements RouteAction {

    private static final Logger LOG = LoggerFactory.getLogger(AccountOnOfflineUpdateAction.class);

    @Autowired
    private AccountService accountService;

    @Override
    @RequestMapping(path = "/onliner/account/update/", method = RequestMethod.POST)
    public CompletableFuture<ActionResponse> route(ActionRequest request) {
        ...
        try {
            ...
            AccountOnOfflineUpdateReq accountSaveReq = JSON.parseObject(bodyJson, AccountOnOfflineUpdateReq.class);
            ...
            LOG.error("execute account onOffline update fail: {}", e);
