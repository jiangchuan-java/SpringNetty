...
public class JackSonUtils {
     ...
     * @return Map<T1, T2>
     */
    public static <T1, T2> Map<T1, T2> json2MapAllowNull(String json, Class<T1> keyClass, Class<T2> valueClass) throws IOException {
        JavaType type = DEFAULT_MAPPER.getTypeFactory().constructMapType(HashMap.class, keyClass, valueClass);
        return DEFAULT_MAPPER.readValue(clean(json), type);
    }
     ...
     * @return
     */
    public static String bean2JsonWithoutError(Object object) {
        try {
            return ESCAPENULL_MAPPER.writeValueAsString(object);
