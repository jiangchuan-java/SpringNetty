...
public class NettyServer {
    ...
    private List<ChannelInboundHandlerAdapter> inboundHandlerAdapterList;

    private List<ChannelOutboundHandlerAdapter> outboundHandlerAdapterList;
    ...
    public NettyServer(int nBossThreads, int nWorkerThreads,
                       List<ChannelInboundHandlerAdapter> inboundHandlerAdapterList,
                       List<ChannelOutboundHandlerAdapter> outboundHandlerAdapterList) throws Exception {
        if (Objects.isNull(inboundHandlerAdapterList)) {
            inboundHandlerAdapterList = new ArrayList<>();
        }
        if (Objects.isNull(outboundHandlerAdapterList)) {
            outboundHandlerAdapterList = new ArrayList<>();
        }
        this.inboundHandlerAdapterList = inboundHandlerAdapterList;
        this.outboundHandlerAdapterList = outboundHandlerAdapterList;
